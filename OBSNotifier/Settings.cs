...
namespace OBSNotifier
{
    class Settings
    {
        ...
        public string SoundForScreenshot { get; set; } = "shutter1.mp3";
        public string SoundForReplaySaved { get; set; } = "notification-4.mp3";
        public string SoundForRecordingStarted { get; set; } = "pluck-on.mp3";
        public string SoundForRecordingStopped { get; set; } = "pluck-off.mp3";
